      ...
      <div className="min-h-screen bg-[#09090b]">
        ...
        <main className={`${useGroupedMenu ? 'lg:ml-56' : 'lg:ml-[72px]'} min-h-screen ${impersonating ? 'pt-26 lg:pt-10' : 'pt-16 lg:pt-0'} transition-all duration-300`}>
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            {/* No License Banner */}
            {!licenseLoading && licenseInfo && !licenseInfo.has_license && (
              <div className="mb-6 bg-amber-950/40 border border-amber-800/50 rounded-lg p-4 flex items-start gap-3" data-testid="no-license-banner">
                <svg className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                </svg>
                <div>
                  <p className="text-sm font-medium text-amber-200">No active license</p>
                  <p className="text-xs text-amber-400/80 mt-1">
                    This site does not have an active license. Some features may be restricted. 
                    Please contact <a href="mailto:info@koodh.com" className="underline hover:text-amber-300">info@koodh.com</a> for licensing inquiries.
                  </p>
                </div>
              </div>
            )}
