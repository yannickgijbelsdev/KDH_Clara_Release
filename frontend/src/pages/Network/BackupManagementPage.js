...
import {
  ...
  Radio, Network, LayoutGrid, ExternalLink, Zap, Plus, Plug,
} from 'lucide-react';
...
export default function BackupManagementPage() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-[#F0F0F2]" style={{ height: '100dvh' }} data-testid="backup-management-page">
      <NetworkHeader activePage="backups" />
