...
class ConnectionManager:
    ...
    def __init__(self):
        # {rundown_id: {websocket: user_info}}
...
async def show_rundown_websocket(
    ...
    """WebSocket endpoint for real-time show rundown collaboration."""
    ...
    # Use prefixed room ID for legacy shows
